...
class Home extends CI_Controller
{
	...
	public function viewHomePage()
	{
		...
		$roomOptionFiles = $contentDir . 'villa-room-details.json';
		$roomOptions = file_get_contents($roomOptionFiles);
		if (!empty($roomOptions)) $roomOptions = json_decode($roomOptions);
