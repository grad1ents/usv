                  ...
                  <div class="box-body">
                            <table class="table is-bordered is-hoverable">
                                <thead class="text-white bg-dark">
                                    ...
                                    <th class="text-white">Stay Duration</th>
                                    <th class="text-white">Email</th>
                                    <th class="text-white">Country</th>
                                    <th class="text-white">Inquiry Made</th>
                                </thead>
                                <tbody class="table-light">
                                    <tr v-for="data in book" class="table-default">
                                        <td style="padding-left:0px!important">{{data.id}}</td> 
                                        <td style="padding-left:0px!important">{{data.roomname}}</td> 
                                        <td style="padding-left:0px!important">{{data.fullname}}</td> 
                                        <td style="padding-left:0px!important">{{data.arrivaldate}} - {{data.departuredate}} ({{data.stayduration}} days)</td> 
                                        <td style="padding-left:0px!important">{{data.email}}</td> 
                                        <td style="padding-left:0px!important">{{data.country}}</td> 
                                        <td style="padding-left:0px!important">{{data.submitdate}}</td> 
                                    </tr>
                                    <tr v-if="emptyResult">
