               ...
               <ul class="sidebar-menu" data-widget="tree">
                  ...
                  <?php endif; ?>
                   ...
                   if($this->user->loggedin && isset($this->user->info->user_role_id) &&
                     ...
                     <li class="<?php if(isset($activeLink['settings']['general'])) echo "active" ?>"><a href="<?php echo site_url("hideend/book/all") ?>"><span class="glyphicon glyphicon-cog sidebar-icon"></span>Book List View</a></li>
                     <li class="<?php if(isset($activeLink['settings']['general'])) echo "active" ?>"><a href="<?php echo site_url("hideend/book/calendar") ?>"><span class="glyphicon glyphicon-cog sidebar-icon"></span>Book Calendar View</a></li>
                  <?php endif; ?>
