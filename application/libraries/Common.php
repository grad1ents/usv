...
function limitString($text, $length = 100, $ending = '...', $exact = false, $considerHtml = true) {
	...
	public function formatIDR($curr,$matauang=null)
	{		
		if ($matauang==null){
			$matauang = "Rp"; 
		}
		return $matauang." ". number_format($curr,0,',','.');
	}
	...
	public function send_email($subject, $body, $emailt,$replayto)
    {
		...
		$CI->email->from('ubudserendipityvillas@gmail.com', "Ubud Serendipity Villa");
        $CI->email->to($emailt);        
